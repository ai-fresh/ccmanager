...
<p align="center">
  <a href="https://github.com/ai-fresh/ccgate/releases/latest"><img src="https://img.shields.io/github/v/release/ai-fresh/ccgate?style=flat-square&color=blue" alt="Latest Release"></a>
...
1. Download `CC Gate-X.Y.Z.pkg` from the [latest release](https://github.com/ai-fresh/ccgate/releases/latest)
...
1. Download `CC Gate-X.Y.Z.dmg` from the [latest release](https://github.com/ai-fresh/ccgate/releases/latest)
